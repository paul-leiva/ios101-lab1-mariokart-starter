...
class ViewController: UIViewController,
  ...
  private func resetKarts() {
    // YOUR CODE HERE
      UIView.animate(withDuration: 0.4) { // these changes should occur over the curation of 0.4 seconds
          // reset the transformations (pan/scale) for the karts to their original state
  ...
  private func runStartingAnimationsOneByOne(completion: (() -> Void)? = nil) {
    // YOUR CODE HERE
      getKartReadyToRace(kart: self.kartView0) { // animate kartView0 first
